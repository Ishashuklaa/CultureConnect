...
// const MpPage = () => {
//   const navigationItems = ['EXPLORE', 'EXPERIENCES', 'PLAN YOUR TRIP', 'BLOGS', 'MEDIA ROOM'];
...
//           <img 
//             src="https://artwolfe.com/wp-content/uploads/2014/06/IND0701300168.jpg" 
//             alt="Tiger in wild" 
...
//                 <span className="text-white text-lg">{feed.title}</span>
//               </div> */}
//             </div>
//           ))}
//         </div>
...
//         <button className="w-14 h-14 bg-green-500 rounded-full flex items-center justify-center text-white shadow-lg">
